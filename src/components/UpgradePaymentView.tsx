...
export default function UpgradePaymentView({
    ...
    const benefits = [
        ...
        { icon: ShieldCheck, text: '隐私保护承诺 (端到端加密)' }
    ];
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto pb-24 lg:pb-8">
                <div className="max-w-4xl mx-auto p-3 md:p-4 lg:p-8 grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8">
                    {/* Left: Benefits & Package */}
                    <div className="space-y-4 md:space-y-6">
                        <div className="bg-gradient-to-br from-amber-400 to-amber-600 rounded-2xl md:rounded-3xl p-5 md:p-8 text-white shadow-lg shadow-amber-200">
                            <h2 className="text-xl md:text-2xl font-bold mb-1 md:mb-2">尊享版</h2>
                            <p className="text-white/80 text-xs md:text-sm mb-4 md:mb-6">一次性开启所有专业功能与定制服务</p>
                            <div className="text-3xl md:text-4xl font-bold mb-5 md:mb-8 flex items-baseline">
                        ...
                        <div className="bg-white rounded-2xl md:rounded-3xl p-4 md:p-6 border border-gray-100 shadow-sm">
                            <h3 className="text-sm md:text-base font-bold text-gray-800 mb-3 md:mb-4 flex items-center">
                                <Star className="w-4 h-4 md:w-5 md:h-5 text-amber-500 mr-2" />
                                为什么选择尊享版？
                            </h3>
                    ...
                    <div className="space-y-4 md:space-y-6">
                        <div className="bg-white rounded-2xl md:rounded-3xl p-4 md:p-6 border border-gray-100 shadow-sm">
                            <h3 className="font-bold text-gray-800 mb-3 md:mb-4">支付详情</h3>
                            <div className="space-y-4">
                                ...
                                <div className="pt-3 md:pt-4 mt-3 md:mt-4 border-t border-gray-100 flex justify-between items-center">
                                    <span className="font-bold text-gray-900">实付金额</span>
                                    <span className="text-2xl md:text-3xl font-bold text-amber-600">¥{totalPrice.toFixed(2)}</span>
                                </div>
                            </div>
                        </div>

                        <div className="bg-white rounded-2xl md:rounded-3xl p-4 md:p-6 border border-gray-100 shadow-sm">
                            <h3 className="font-bold text-gray-800 mb-3 md:mb-4">支付方式</h3>
                            <div className="space-y-3">
                                <div className="flex items-center justify-between p-3 md:p-4 border-2 border-primary bg-teal-50 rounded-xl md:rounded-2xl">
                                    <div className="flex items-center space-x-2 md:space-x-3">
                                        <CreditCard className="w-4 h-4 md:w-5 md:h-5 text-primary" />
                                        <span className="text-sm md:text-base font-medium text-gray-800">在线支付</span>
                                    </div>
            ...
            <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 p-3 md:p-4 z-20 lg:p-6 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
                <div className="max-w-4xl mx-auto flex items-center justify-between gap-4">
                    ...
                    <button
                        ...
                        className="flex-1 lg:w-64 py-3 md:py-4 bg-gray-900 text-white rounded-xl md:rounded-2xl font-bold shadow-lg hover:bg-black transition-all flex items-center justify-center space-x-2 disabled:opacity-50 cursor-pointer"
                    >
